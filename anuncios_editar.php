                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de gerenciamento :: Anúncios :: Editar</h3>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <form class="card-body" action="functions/anuncios_editar.php"
                                      enctype="multipart/form-data"
                                      method="post">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                <h4 class="mt-0 header-title">Anúncios</h4>
                                                <p class="text-muted m-b-30 font-14">Editar anúncio</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                    ...
                                    $pegaid = (int)$_GET['id'];
                                    $sql = "select id,titulo,local,link FROM publicidade_anuncio where id = '$pegaid'";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' readonly name='local' type='text' value='$row[local]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";
                                        ...
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' name='link' type='text' value='$row[link]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";
                                    }
